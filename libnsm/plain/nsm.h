 ...
 */
enum ErrorCode nsm_extend_pcr(int32_t fd,
                              uint16_t index,
                              const uint8_t *data,
                              uint32_t data_len,
                              uint8_t *pcr_data,
 ...
 * *Returns*: The status of the operation.
 */
enum ErrorCode nsm_describe_pcr(int32_t fd,
                                uint16_t index,
                                bool *lock,
                                uint8_t *data,
                                uint32_t *data_len);
 ...
 * *Returns*: The status of the operation.
 */
enum ErrorCode nsm_lock_pcr(int32_t fd, uint16_t index);
 ...
 * *Returns*: The status of the operation.
 */
enum ErrorCode nsm_lock_pcrs(int32_t fd, uint16_t range);
 ...
 * *Returns*: The status of the operation.
 */
enum ErrorCode nsm_get_description(int32_t fd, struct NsmDescription *nsm_description);
 ...
 * *Returns*: The status of the operation.
 */
enum ErrorCode nsm_get_attestation_doc(int32_t fd,
 ...
 */
enum ErrorCode nsm_get_random(int32_t fd, uint8_t *buf, uintptr_t *buf_len);
