...
py_module_initializer!(libnsm, |py, m| {
    ...
    m.add(py, "nsm_get_attestation_doc_nonce", py_fn!(py, nsm_get_attestation_doc_nonce_py(
        fd: i32,
        nonce: PyBytes,
        nonce_len: u32,
        pub_key_data: PyBytes,
    ...
    m.add(py, "nsm_get_attestation_doc_nonce_user_data", py_fn!(py, nsm_get_attestation_doc_nonce_user_data_py(
        fd: i32,
        nonce: PyBytes,
        nonce_len: u32,
        user_data: PyBytes,
...
unsafe fn nsm_get_attestation_doc_nonce_py(
    py: Python,
    fd: i32,
    nonce: PyBytes,
    nonce_len: u32,
    ...
    let user_data: *const u8 = ptr::null();
    let user_data_len = 0;
    let nonce_data_rust= nonce.data(py);
...
unsafe fn nsm_get_attestation_doc_nonce_user_data_py(
    py: Python,
    fd: i32,
    nonce: PyBytes,
    nonce_len: u32,
    ...
    let request = Request::Attestation {
        user_data: get_byte_buf_from_user_data(user_data_ptr, user_data_len),
        nonce: get_byte_buf_from_user_data(nonce_data_ptr, nonce_len),
        public_key: get_byte_buf_from_user_data(pub_key_data_ptr, pub_key_len),
    };
